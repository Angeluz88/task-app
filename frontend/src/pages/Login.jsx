...
export default function Login() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center transition-colors duration-500 ${isParent ? 'bg-linear-to-r from-[#a1c4fd] to-[#c2e9fb]' : 'bg-linear-to-r from-[#a1c4fd] to-[#c2e9fb]'}`}>
